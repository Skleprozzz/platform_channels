...
class AppDeviceHelperSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: AppDeviceHelper?) {
    let getAppInfoChannel = FlutterBasicMessageChannel(name: "custom.channel_name.getAppInfo", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getDeviceInfoChannel = FlutterBasicMessageChannel(name: "custom.channel_name.getDeviceInfo", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getBatteryLevelChannel = FlutterBasicMessageChannel(name: "custom.channel_name.getBatteryLevel", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
