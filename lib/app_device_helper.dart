...
class AppDeviceHelper {
  ...
  static const EventChannel eventChannel =
      EventChannel('custom.channel_name.getChargingStatus');

  static const EventChannel eventBatteryChargingChannel =
      EventChannel('custom.channel_name.getBatteryStatus');

  late Stream chargingStatusStream;

  late Stream batteryValueStream;

  void init() {
    chargingStatusStream = eventChannel.receiveBroadcastStream();
    batteryValueStream = eventBatteryChargingChannel.receiveBroadcastStream();
  }

  Future<AppInfo> getAppInfo() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'custom.channel_name.getAppInfo', codec,
  ...
  Future<DeviceInfo> getDeviceInfo() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'custom.channel_name.getDeviceInfo', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList = await channel.send(null) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
  ...
  Future<int> getBatteryLevel() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'custom.channel_name.getBatteryLevel', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList = await channel.send(null) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
